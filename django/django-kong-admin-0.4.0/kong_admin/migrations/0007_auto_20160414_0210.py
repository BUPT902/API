...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(help_text='API\u63cf\u8ff0', max_length=1024, null=True),
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            model_name='keyauthreference',
            name='key',
            field=models.UUIDField(help_text='You can optionally set your own unique key to authenticate the client. If missing, the plugin will generate one.', null=True, editable=False, blank=True),
        ),
        migrations.AlterField(
